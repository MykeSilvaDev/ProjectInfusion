function Menu(config){
	...
	var _opened = false;
	var _this = this;
/*QUANDO O USUÁRIO INSTANCIAR O NOVO MENU EU PRECISO REMOVER O ATRIBUTO STYLE DO MEU BOTÃO*/
	this.btn.removeAttribute('style')
	//closeMenu()
/*TODA VEZ QUE EU FIZER UM REDISIONAMENTO NA TELA EU VOU CRIAR UMA FUNÇÃO (RESIZE)*/
	if(this.maxWidth){
